...
export class NumbersMultiplesCircledV1 extends core.GraphControllerV3  {
    ...
    async init() {
        ...
        this.number = new elements.HtmlNumberCircle(this, this.parameters[0][this.index], this.el)
