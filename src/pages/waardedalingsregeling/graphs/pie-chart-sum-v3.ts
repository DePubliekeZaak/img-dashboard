...
import HtmlLegendAsSumV2 from '../../shared/html/html-legend-sum-v2';
import { parseSegment } from '../../shared/factories/segment';


export class PieChartSumV3 extends core.GraphControllerV3  {
    ...
    html() {
        ...
        this.legend = new HtmlLegendAsSumV2(this);
    ...
    async draw(data: DataObject) {
        ...
        this.chartPie.draw(data.pies[this.index].filter( (d,i) => d.include));
        const legendEl = this.legend.draw(data.pies[this.index]);
        // legendEl.style.marginTop = "4rem";
    }
