...
const pageConfig: IPageConfig = {
  ...
  endpoints: [
    ...
    "gemeenten?aggregatie=eq.week&domein_code=eq.FYSIEK&regeling_code=eq.MW&order=periode.desc&periode_vanaf=gte.2025-01-01&gemeente=eq.{GEMEENTE}",
  ],
  groups: [
    {
        ...
        "endpoints": ["gemeenten?aggregatie=eq.maand&domein_code=eq.FYSIEK&regeling_code=eq.MW&gemeente=eq.{GEMEENTE}","gemeenten?aggregatie=eq.week&domein_code=eq.FYSIEK&regeling_code=eq.MW&order=periode.desc&periode_vanaf=gte.2025-01-01&gemeente=eq.{GEMEENTE}"],
    },
    // {
    //     "slug" : "gemeenten_vv",
    //     "ctrlr": "MuniGroupV1",
