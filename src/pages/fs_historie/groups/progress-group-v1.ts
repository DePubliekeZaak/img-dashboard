...
export class ProgressGroupV1 extends GroupControllerV1 { 
    ...
    prepareData(data: ImgData) : any {
        ...
        let { tableParams, graphParams, graphData, graphData_alt,timeline, definitions } = super.prepareData(data);
        ...
        timeline = timeline.filter ( i => new Date(i.date) < new Date('2023-05-01'));
