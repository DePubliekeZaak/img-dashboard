...
const mappings: IGroupMappingV2[] = [
    ...
    graphs: [
      {
        ...
        parameters: [
          [
            ...
            {
              label: "Verleend",
              column: "all_bedrag_verleend_totaal",
              colour: "blue",
              format: "currency",
              units: "totaal besloten bedrag",
            },
          ],
          [],
        ],
  ...
  //           {
  //             label: "Waardedalingsregeling",
  //             column: "wd_bedrag_verleende_schade",
  //             colour: "moss",
  //             format: "currency",
  //           },
  //           {
  //             label: "Immateriele schade",
  //             column: "ims_bedrag_verleende_schade",
  //             colour: "blue",
  //             format: "currency",
  //           },
  //           {
  //             label: "Fysieke schade",
  //             column: "fs_bedrag_verleende_schade",
  //             colour: "orange",
  //             format: "currency",
  //           },
  //         ],
  ...
  //           {
  //             label: "Duur",
  //             column: "ves_mediaan_dagen",
  //             colour: "orange",
  //             units: "mediaan dagen tot besluit",
  //           },
  //           {
  //             label: "Toekenningspercentage",
  //             column: "ves_toegekend_percentage_cumulatief",
  //             colour: "moss",
  //             format: "percentage",
  //             units: "toegekend",
  //           },
  //           {
  //             label: "Bezwaarpercentage",
  //             column: "ves_bezwaar_percentage_cumulatief",
  //             colour: "blue",
  //             format: "percentage",
  //             units: "bezwaar gemaakt",
  //           },
  ...
  //           {
  //             label: "Duur",
  //             column: "wd_mediaan_dagen",
  //             colour: "orange",
  //             units: "mediaan dagen tot besluit",
  //           },
  //           {
  //             label: "Toekenningspercentage",
  //             column: "wd_toegekend_percentage_cumulatief",
  //             colour: "moss",
  //             format: "percentage",
  //             units: "toegekend",
  //           },
  //           {
  //             label: "Bezwaarpercentage",
  //             column: "wd_bezwaar_percentage_cumulatief",
  //             colour: "blue",
  //             format: "percentage",
  //             units: "bezwaar gemaakt",
  //           },
  ...
  //   },
  //   functionality: ["table", "definitions", "download"],
  //   endpoints: ["all_wekelijks", "all_maandelijks", "tevredenheid"],
  // },
];
