...
export class ProgressGroupV1 extends GroupControllerV1 { 
    ...
    prepareData(data: ImgData) : any {
        ...
        const { tableParams, graphData, timeline, definitions } = super.prepareData(data);
        
        const i = 0;
        for (let m of graphData) {
            m["aantal_respondenten_maand"] = m["aantal_respondenten"] - graphData[i+1]["aantal_respondenten"];
        }
