...
import { fillEmptyMonths, relyOnCompleted } from "../../shared/factories/group";
...
export class KTOTrendV1 extends GroupControllerV1 { 
    ...
    prepareData(data: ImgData) : any {
        ...
        const {tableParams, graphParams, timeline, definitions} = super.prepareData(data);
        ...
        return {
            ...
            graphData: _data.sort((a,b) => a._yearmonth < b._yearmonth ? 1 : -1),
            timeline,
            definitions,
            table
        }
