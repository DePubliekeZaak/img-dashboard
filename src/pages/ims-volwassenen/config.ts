...
const group: IGroupMappingV2[] = [
    ...
    graphs: [
      {
        ...
        parameters: [
          [
            ...
            {
              label: "Verleend",
              column: "ims_volw_bedrag_verleend_totaal",
              colour: "moss",
              format: "currency",
            ...
            {
              label: "Uitgekeerd",
              column: "ims_volw_bedrag_uitgekeerd_totaal",
              colour: "orange",
              format: "currency",
        ...
        segment: {
          key: "ims_volw_bedrag_verleend_totaal",
          cumulative: true,
          periodization: "weekly",
        },
      },
  ...
  },
  {
    ...
    graphs: [
      {
        slug: "ims_volw_toegewezen_taart",
        ctrlr: "PieChartSumV1",
        args: [],
        parameters: [
          [
      ...
      {
        slug: "ims_volw_toegewezen_trend",
  ...
  },
  {
    ...
    graphs: [
      ...
      },
      {
        ...
        segment: {
          key: "ims_volw_dlt_gerealiseerd_gemiddeld_dagen",
          cumulative: false,
          periodization: "monthly",
          label: "dagen",
        },
