...
export class NumbersV1 extends core.GraphControllerV3  {
    ...
    prepareData(data: DataObject) : DataObject {
        ...
        // const meldingen_cvw = 11243;

        data.totals = data.graphData[0];

        // data.totals["fysieke_schade_meldingen_cvw"] = meldingen_cvw;
        // data.totals["fysieke_schade_meldingen_img"] = data.totals["fysieke_schade_meldingen_cumulatief"] - meldingen_cvw
    ...
    async redraw(data: any, range: number[]) {
        ...
        for (let p of this.parameters[0]) {
            this.numbers[p.column].redraw(data.totals)
        }
    }
