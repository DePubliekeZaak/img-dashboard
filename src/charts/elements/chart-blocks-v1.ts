...
export class ChartBlocksV1 {
  ...
  draw(data: PiePart[]) {
    ...
    this.ctrlr.svg.text = this.ctrlr.svg.layers.data
      .append("text")
      .text(percentage + "%")
      .attr("text-anchor", "end")
  ...
  redraw(data) {
    ...
    this.ctrlr.svg.desc.attr("x", size - xOffset).attr("y", size - yOffset + 0);
  }
}
