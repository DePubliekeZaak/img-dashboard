    ...
    this.svg.layers.data = this.svg.body
      ...
      .attr(
        ...
        "translate(" +
          ...
          "," +
          this.config.innerPadding.top +
          ")",
      );

    this.svg.layers.axes = this.svg.body.append("g").attr("class", "axes");
    //    .attr('transform', 'translate(' + (this.config.padding.left) + ',' + (this.config.padding.top) + ')');
